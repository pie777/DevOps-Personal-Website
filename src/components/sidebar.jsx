        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            ...
            <div className="text-center">
              ...
              <span className="position" style={{color:"#27bee4"}}>DevOps Engineer/Full Stack Software Developer</span>
            ...
            <nav id="colorlib-main-menu" role="navigation" className="navbar">
              <div id="navbar" className="collapse">
                <ul>
                  ...
                  <li><a href="#certification" data-nav-section="certification">Certifications</a></li>
